    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <span id="cart-count" class="badge bg-primary rounded-pill">{{$jmlmenudibeli ?? 0}}</span>
        </h4>
                  ...
                  <div class="col mb-4">
                    <div class="product-item bg-white p-3 rounded shadow-sm">
                      ...
                      <div class="product-details">
                        <h3 class="product-title fs-5 mb-2">{{$p->nama_barang}}</h3>
                        ...
                        <div class="price-wrap mb-3">
                          <span class="price fs-5 fw-bold text-primary">{{rupiah($p->harga_barang*1.2)}}</span>
                        </div>
