...
<body>
    <div class="invoice-box">
        ...
        <div class="info">
            ...
            <strong>Nama Vendor:</strong> {{ $nama_vendor }}<br>
...
<tbody>
    ...
    <tr>
        ...
        <td>{{ $item->total_bahan_baku }}</td>
        <td class="text-right">{{ rupiah($item->harga_beli, 0, ',', '.') }}</td>
        <td class="text-right">{{ rupiah($item->harga_beli * $item->total_bahan_baku, 0, ',', '.') }}</td>
    </tr>
    @endforeach
    <tr>
